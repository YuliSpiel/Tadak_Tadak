...
public class WateringCan : MonoBehaviour
{
    ...
    public float rayDistance = 0.6f; // 물을 뿌리는 거리
    ...
    private Animator _waterAnim;
    void Awake()
    {
        game = GetComponentInParent<WateringGame>();
        _waterAnim = GetComponentInChildren<Animator>();
    }
    ...
    void SprayWater()
    {
        ...
        Debug.DrawRay(spoutPos.position, -spoutPos.right * rayDistance, Color.red, 0.1f); // 디버그용 레이 시각화
